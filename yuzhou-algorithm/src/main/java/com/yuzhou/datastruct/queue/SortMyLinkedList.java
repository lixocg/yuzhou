package com.yuzhou.datastruct.queue;

import com.yuzhou.datastruct.mycollection.MylinkeList;
 ...
 * 排序list的简单实现
 */
public class SortMyLinkedList<T extends Comparable<? extends T>> extends MylinkeList<T>
